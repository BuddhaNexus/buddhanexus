...
async def search(search_input: SearchInput):
    ...
    query_languages = ["sa", "bo", "zh", "pa"] # lang codes here are hard-coded, sue me! for debugging purposes, when we only need sanskrit or pali, you can limit the indicies by supplying only the specific language tag     
