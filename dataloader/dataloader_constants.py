...
VIEW_SEARCH_INDEX = "search_index_view"
VIEW_SEARCH_INDEX_CHN = "search_index_chn_view"

INDEX_VIEW_NAMES = (VIEW_SEARCH_INDEX, VIEW_SEARCH_INDEX_CHN)

INDEX_COLLECTION_NAMES = (COLLECTION_SEARCH_INDEX, COLLECTION_SEARCH_INDEX_CHN)
