...
def load_all_menu_collections(db: StandardDatabase):
    ...
    for language in DEFAULT_LANGS:
        ...
        collections_schema = f"{METADATA_DIR}/schemas/collections.json"  # TODO: no hardcoding
...
def load_all_menu_categories(db: StandardDatabase):
    ...
    for language in DEFAULT_LANGS:
        categories_filepath = f"{METADATA_DIR}{language}-categories.json"   # TODO: no hardcoding
        categories_schema = f"{METADATA_DIR}/schemas/categories.json"   # TODO: no hardcoding
