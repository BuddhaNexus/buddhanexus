...
function NumbersPage() {
    ...
    var _b = (0, react_query_1.useQuery)({
        queryKey: dbApi_1.DbApi.NumbersView.makeQueryKey({ fileName: fileName, queryParams: queryParams }),
        queryFn: function () {
            return dbApi_1.DbApi.NumbersView.call({
                fileName: fileName,
                queryParams: queryParams,
            });
        },
        refetchOnWindowFocus: false,
    }), isLoading = _b.isLoading, isError = _b.isError;
    if (isError) {
    ...
    return (<PageContainer_1.PageContainer maxWidth="xl" backgroundName={sourceLanguage} hasSidebar={true}>
      ...
      {isLoading ? (<CenteredProgress_1.CenteredProgress />) : (<>
          <material_1.Typography variant="h1">TODO</material_1.Typography>
          {/* {data?.collections &&
