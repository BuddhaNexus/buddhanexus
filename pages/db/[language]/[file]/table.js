...
var TableView_1 = require("features/tableView/TableView");
...
function TablePage() {
    ...
    var _b = (0, react_query_1.useInfiniteQuery)({
        initialPageParam: 0,
        queryKey: dbApi_1.DbApi.TableView.makeQueryKey({
            fileName: fileName,
            queryParams: queryParams,
        }),
        queryFn: function (_a) {
            var pageParam = _a.pageParam;
            return dbApi_1.DbApi.TableView.call({
                fileName: fileName,
                queryParams: queryParams,
    ...
    }), data = _b.data, fetchNextPage = _b.fetchNextPage, fetchPreviousPage = _b.fetchPreviousPage, isInitialLoading = _b.isInitialLoading;
    ...
    return (<PageContainer_1.PageContainer maxWidth="xl" backgroundName={sourceLanguage} hasSidebar={true}>
      ...
      {isInitialLoading || !data ? (<CenteredProgress_1.CenteredProgress />) : (<TableView_1.default data={allData} onEndReached={fetchNextPage} onStartReached={fetchPreviousPage}/>)}
