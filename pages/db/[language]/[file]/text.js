...
var TextView_1 = require("features/textView/TextView");
...
function TextPage() {
    ...
    var selectedSegment = queryParams.selectedSegment, paramsThatShouldRefreshText = __rest(queryParams, ["selectedSegment"]);
    var _b = (0, react_query_1.useInfiniteQuery)({
        initialPageParam: 0,
        queryKey: dbApi_1.DbApi.TextView.makeQueryKey({
            fileName: fileName,
            queryParams: paramsThatShouldRefreshText,
        }),
        queryFn: function (_a) {
            var pageParam = _a.pageParam;
            return dbApi_1.DbApi.TextView.call({
                fileName: fileName,
        ...
        getPreviousPageParam: function (lastPage) {
            return lastPage.pageNumber === 0 ? undefined : lastPage.pageNumber - 1;
        },
        refetchOnWindowFocus: false,
    }), data = _b.data, fetchNextPage = _b.fetchNextPage, fetchPreviousPage = _b.fetchPreviousPage, isInitialLoading = _b.isInitialLoading, isError = _b.isError;
    var allData = (0, react_1.useMemo)(function () { return (data ? data.pages.flatMap(function (page) { return page.data; }) : []); }, [data]);
    if (isError) {
    ...
    return (<PageContainer_1.PageContainer maxWidth="xl" backgroundName={sourceLanguage} hasSidebar={true}>
      ...
      {isInitialLoading || !data ? (<CenteredProgress_1.CenteredProgress />) : (<TextView_1.default data={allData} onEndReached={fetchNextPage} onStartReached={fetchPreviousPage}/>)}
