...
function Page(_a) {
    var page = _a.page;
    var _b = page.meta, title = _b.title, _c = _b.componentList, componentList = _c === void 0 ? [] : _c, _d = _b.propsList, propsList = _d === void 0 ? [] : _d, _e = _b.importsList, importsList = _e === void 0 ? [] : _e, content = page.content;
    ...
    return (<PageContainer_1.PageContainer>
      <material_1.Paper elevation={1} sx={{ py: 3, px: 4 }}>
        <material_1.Typography variant="h2" component="h1">
          {title}
...
var getStaticProps = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var i18nProps, dirSlug, page, content;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    i18nProps = _b.sent();
                    dirSlug = params.slug;
                    page = (0, mdxPageHelpers_1.getMDXContentBySlug)("content/pages", dirSlug, locale);
                    return [4 /*yield*/, (0, serialize_1.serialize)(page.content)];
                case 2:
                    content = _b.sent();
                    return [2 /*return*/, {
                            props: __assign({ page: __assign(__assign({}, page), { content: content }) }, i18nProps.props),
                        }];
            }
        });
    });
...
var getStaticPaths = function (_a) {
    ...
    var dirnames = fs_1.default.readdirSync(path_1.default.join("content", "pages"));
